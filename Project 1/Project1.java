...
public class Project1{
   ...
   public static void main(String[] args){ 
      ...
      */
      ...
      String myName = "Kai Ye";
      String myAge = "26";
      String collegeYear = "Sophomore";
      String myMajor = "Math Computing";
      String transferMajor = "Computer Science";
      System.out.println("My name is " + myName);
      System.out.println("I am " + myAge + "years old");
      System.out.println("I am a " + collegeYear);
      System.out.println("I am major in " + myMajor);
      System.out.println("I want to transfer my major to " + transferMajor);
