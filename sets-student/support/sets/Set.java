...
public interface Set<E> extends Iterable<E> {
   ...
   * 'this' set is also contained in <code>that</code> set.
   *
   ...
   *
   * @param  other  the <code>Set</code> to subtract from this one
   ...
   * return a new <code>Set</code> that is the same as <code>this</code>
